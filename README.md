...
Run this post-hoc analysis after `8_baselineComparison.py`. It computes the final comparative metrics, and writes predictions and figures to `<benchmark_dir>/analysis/`.
