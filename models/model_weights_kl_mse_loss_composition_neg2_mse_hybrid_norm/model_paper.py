...
class MultiHeadAttentionBlock(tf.keras.layers.Layer):
    ...
    def __init__(
        ...
        attention_dropout_rate=0.05,  # 0.1,
...
class SinusoidalPositionalEncoding(tf.keras.layers.Layer):
    """
    Sinusoidal positional encoding for 1D sequences, with a learnable scale.
    ...
    def call(self, x):
        ...
        channel_idx = tf.cast(tf.range(channels)[tf.newaxis, :], tf.float32)  # [1, C]
...
class CustomModel(tf.keras.Model):
    ...
    def __init__(
        ...
        # dense_units=[1024, 768, 512, 384],
        # branch_units=[256, 128, 64, 32, 16],
        branch_units=[256, 64, 16],
        # branch_units=[256, 128, 32],
        ...
        **kwargs,
        ...
        # self.composition_value_layer = tf.keras.layers.Dense(
        #     n_outputs, activation=scaled_sigmoid, name="composition_value_dense"
        # )
        # self.composition_gate_layer = tf.keras.layers.Dense(
        #     n_outputs, activation="sigmoid", name="composition_gate_dense"
        # )
    ...
    def _apply_stem(self, x, training=False):
        ...
        x = self.stem_fuse(x)
        # x = self.stem_ln2(x, training=training)
        # x = self.stem_act2(x)
    ...
    def _build_conv_layers(self):
        ...
        ################## BEST CONFIG ##################################
        # conv_configs = [
        #     {"filters": 32, "kernel_size": 11, "downsample": True, "stride": 3},
        #     {"filters": 48, "kernel_size": 9, "downsample": True, "stride": 3},
        #     {"filters": 64, "kernel_size": 7, "downsample": True, "stride": 2},
        ...
        #     {"filters": 48, "kernel_size": 9, "downsample": True, "stride": 2},
        #     {"filters": 64, "kernel_size": 7, "downsample": True, "stride": 2},
        #     {"filters": 72, "kernel_size": 5, "downsample": True, "stride": 2},
        #     {"filters": 96, "kernel_size": 3, "downsample": True, "stride": 2},
        ...
        ################## NEW CONFIG ##################################
        # conv_configs = [
        #     {"filters": 24, "kernel_size": 11, "downsample": True, "stride": 2},
        ...
        #     {"filters": 72, "kernel_size": 3, "downsample": True, "stride": 2},
        #     {"filters": 96, "kernel_size": 3, "downsample": True, "stride": 2},
        ...
        #     {"filters": 72,  "kernel_size": 5, "downsample": True, "stride": 2},
        #     {"filters": 96,  "kernel_size": 3, "downsample": True, "stride": 2},
        #     {"filters": 120, "kernel_size": 3, "downsample": True, "stride": 2},
        #     {"filters": 120, "kernel_size": 3, "downsample": True, "stride": 1},
        # ]
        ################## NEW 3 CONFIG ##################################
        conv_configs = [
    ...
    def _build_attention_layer(self):
        ...
        self.multi_head_attention = MultiHeadAttentionBlock(
            filters=96,  # TODO: match last conv block filters
    ...
    def call(self, inputs, training=False, return_attention_weights=False):
        ...
        ####################
        # composition_value = self.composition_value_layer(xb)   # in (0, 1)
        # composition_gate  = self.composition_gate_layer(xb)    # in (0, 1)

        # # Output composto in [-1, 1], compatibile con neg2_mse_hybrid
        # composition_output = composition_gate * composition_value + (1.0 - composition_gate) * (-1.0)
        ########################################
